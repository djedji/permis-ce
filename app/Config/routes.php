<?php
    ...
    Router::connect('/questions-echouees/ajax',
        array('controller' => 'questionsEchouees', 'action' => 'ajax')
    );

    Router::connect('/questions-echouees/:slug-:id',
        array('controller' => 'questionsEchouees', 'action' => 'index'),
    ...
    Router::connect('/questions-echouees', array('controller' => 'questionsEchouees', 'action' => 'index'));
